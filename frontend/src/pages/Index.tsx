            ...
            <TabsList className="grid grid-cols-4 w-full gap-1 p-2 bg-card">
              ...
              <div className="relative">
                <button
                  ...
                  className={`flex flex-col items-center py-2 text-xs w-full rounded-lg transition-colors ${["nutrition", "health", "alerts", "chatbot"].includes(
                    activeTab,
                  )
                ...
                >
                  <TabsTrigger
                    ...
                    className={`w-full py-2 px-3 text-xs flex justify-start items-center gap-3 rounded-lg transition-colors ${activeTab === "nutrition"
                        ? "bg-gray-100 text-green-700"
                        : "hover:bg-gray-50 text-gray-700"
                      }`}
                  >
                    <ClipboardList
                      className={`h-4 w-4 flex-shrink-0 ${activeTab === "nutrition"
                          ? "text-green-600"
                          : "text-gray-600"
                        }`}
                    />
                  ...
                  <TabsTrigger
                    ...
                    className={`w-full py-2 px-3 text-xs flex justify-start items-center gap-3 rounded-lg transition-colors ${activeTab === "alerts"
                        ? "bg-gray-100 text-green-700"
                        : "hover:bg-gray-50 text-gray-700"
                      }`}
                  >
                    <Bell
                      className={`h-4 w-4 flex-shrink-0 ${activeTab === "alerts"
                          ? "text-green-600"
                          : "text-gray-600"
                        }`}
                    />
                  ...
                  <TabsTrigger
                    ...
                    className={`w-full py-2 px-3 text-xs flex justify-start items-center gap-3 rounded-lg transition-colors ${activeTab === "chatbot"
                        ? "bg-gray-100 text-green-700"
                        : "hover:bg-gray-50 text-gray-700"
                      }`}
                  >
                    <MessageSquare
                      className={`h-4 w-4 flex-shrink-0 ${activeTab === "chatbot"
                          ? "text-green-600"
                          : "text-gray-600"
                        }`}
                    />
